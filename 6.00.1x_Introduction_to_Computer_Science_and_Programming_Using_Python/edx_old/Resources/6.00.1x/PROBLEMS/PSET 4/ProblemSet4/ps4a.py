...
WORDLIST_FILENAME = "H:\SEB SPINEL\DOCUMENTOS\ESTUDIO\Introduction to Computer Science and Programming\PROBLEMS\PSET 4\ProblemSet4/words.txt"
...
def playGame(wordList):
    ...
    while askUser != 'e':
        ...
        askUser = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
